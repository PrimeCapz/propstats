"""
🏀 NBA Props Research Tool - OPTIMIZED
Premium PropFinder-style card design with three-tier navigation
"""
...
# [Include all the team data, rosters, and helper functions from the original app]
TEAM_COLORS = {
...
TEAM_ROSTERS = {
    'LAL': [
        {'id': '2544', 'name': 'LeBron James', 'pos': 'F', 'number': '23', 'stats': {'points': 25.5, 'rebounds': 7.2, 'assists': 8.1}},
        {'id': '203076', 'name': 'Anthony Davis', 'pos': 'C', 'number': '3', 'stats': {'points': 27.8, 'rebounds': 11.3, 'assists': 3.5}},
    ],
    'GSW': [
        {'id': '201939', 'name': 'Stephen Curry', 'pos': 'G', 'number': '30', 'stats': {'points': 26.4, 'rebounds': 4.5, 'assists': 5.2, 'threes': 4.8}},
        {'id': '203110', 'name': 'Klay Thompson', 'pos': 'G', 'number': '11', 'stats': {'points': 19.5, 'rebounds': 3.5, 'assists': 2.3, 'threes': 3.2}},
    ],
    'BOS': [
        {'id': '1628369', 'name': 'Jayson Tatum', 'pos': 'F', 'number': '0', 'stats': {'points': 28.2, 'rebounds': 8.6, 'assists': 4.9}},
        {'id': '1628464', 'name': 'Jaylen Brown', 'pos': 'G-F', 'number': '7', 'stats': {'points': 24.7, 'rebounds': 6.1, 'assists': 3.5}},
    ],
    'DAL': [
        {'id': '1629029', 'name': 'Luka Doncic', 'pos': 'G', 'number': '77', 'stats': {'points': 32.4, 'rebounds': 8.0, 'assists': 9.8}},
        {'id': '1626157', 'name': 'Kyrie Irving', 'pos': 'G', 'number': '2', 'stats': {'points': 25.2, 'rebounds': 4.9, 'assists': 5.3}},
    ],
    'MIL': [
        {'id': '203507', 'name': 'Giannis Antetokounmpo', 'pos': 'F', 'number': '34', 'stats': {'points': 31.1, 'rebounds': 11.2, 'assists': 6.1}},
        {'id': '203081', 'name': 'Damian Lillard', 'pos': 'G', 'number': '0', 'stats': {'points': 25.7, 'rebounds': 4.3, 'assists': 7.6}},
    ],
    'PHI': [
        {'id': '203954', 'name': 'Joel Embiid', 'pos': 'C', 'number': '21', 'stats': {'points': 29.5, 'rebounds': 10.8, 'assists': 5.2}},
        {'id': '1630178', 'name': 'Tyrese Maxey', 'pos': 'G', 'number': '0', 'stats': {'points': 27.4, 'rebounds': 3.8, 'assists': 6.9}},
    ],
    'DEN': [
        {'id': '203999', 'name': 'Nikola Jokic', 'pos': 'C', 'number': '15', 'stats': {'points': 27.9, 'rebounds': 12.3, 'assists': 9.2}},
        {'id': '1628378', 'name': 'Jamal Murray', 'pos': 'G', 'number': '27', 'stats': {'points': 21.2, 'rebounds': 4.1, 'assists': 6.5}},
    ],
    'PHX': [
        {'id': '201142', 'name': 'Kevin Durant', 'pos': 'F', 'number': '35', 'stats': {'points': 28.3, 'rebounds': 6.8, 'assists': 5.0}},
        {'id': '1626164', 'name': 'Devin Booker', 'pos': 'G', 'number': '1', 'stats': {'points': 26.8, 'rebounds': 4.6, 'assists': 6.9}},
    ],
    'OKC': [
        {'id': '1628983', 'name': 'Shai Gilgeous-Alexander', 'pos': 'G', 'number': '2', 'stats': {'points': 30.8, 'rebounds': 5.5, 'assists': 6.2}},
        {'id': '1630602', 'name': 'Chet Holmgren', 'pos': 'C', 'number': '7', 'stats': {'points': 16.9, 'rebounds': 7.8, 'assists': 2.5}},
    ],
    'MIN': [
        {'id': '1630162', 'name': 'Anthony Edwards', 'pos': 'G', 'number': '5', 'stats': {'points': 27.6, 'rebounds': 5.4, 'assists': 5.1}},
        {'id': '203497', 'name': 'Rudy Gobert', 'pos': 'C', 'number': '27', 'stats': {'points': 13.8, 'rebounds': 12.9, 'assists': 1.2}},
    ],
    'MIA': [
        {'id': '1628389', 'name': 'Bam Adebayo', 'pos': 'C', 'number': '13', 'stats': {'points': 19.4, 'rebounds': 10.2, 'assists': 4.1}},
        {'id': '1630527', 'name': 'Tyler Herro', 'pos': 'G', 'number': '14', 'stats': {'points': 23.8, 'rebounds': 5.3, 'assists': 5.0}},
    ],
    'NYK': [
        {'id': '1629649', 'name': 'Jalen Brunson', 'pos': 'G', 'number': '11', 'stats': {'points': 28.1, 'rebounds': 3.8, 'assists': 6.7}},
        {'id': '1629628', 'name': 'Julius Randle', 'pos': 'F', 'number': '30', 'stats': {'points': 24.3, 'rebounds': 9.2, 'assists': 5.0}},
    ],
    'CLE': [
        {'id': '1628378', 'name': 'Donovan Mitchell', 'pos': 'G', 'number': '45', 'stats': {'points': 27.8, 'rebounds': 5.3, 'assists': 6.2}},
        {'id': '1629029', 'name': 'Evan Mobley', 'pos': 'F-C', 'number': '4', 'stats': {'points': 16.2, 'rebounds': 9.4, 'assists': 3.1}},
    ],
    'ATL': [
        {'id': '1629027', 'name': 'Trae Young', 'pos': 'G', 'number': '11', 'stats': {'points': 26.4, 'rebounds': 2.8, 'assists': 10.8}},
    ],
    'MEM': [
        {'id': '1629630', 'name': 'Ja Morant', 'pos': 'G', 'number': '12', 'stats': {'points': 25.9, 'rebounds': 5.8, 'assists': 8.1}},
    ],
    'BKN': [
        {'id': '1629028', 'name': 'Mikal Bridges', 'pos': 'F', 'number': '1', 'stats': {'points': 21.8, 'rebounds': 4.5, 'assists': 3.7}},
    ]
}
...
def calculate_propscore(hit_rate, season_avg, line, consistency, difficulty):
    """
    Calculate PropScore (0-100) based on multiple factors
    Higher score = stronger OVER recommendation
    Lower score = stronger UNDER recommendation
    """
    # Base score from hit rate (0-40 points)
    hit_score = (hit_rate / 100) * 40

    # Margin score: how far above/below line (0-30 points)
...
def get_matchup_difficulty(opponent_team, player_pos):
    ...
    if def_rank <= 10:
        return 'hard', f"OPP DEF RANK: #{def_rank} vs {player_pos}"
    elif def_rank <= 20:
        return 'medium', f"OPP DEF RANK: #{def_rank} vs {player_pos}"
    else:
        return 'easy', f"OPP DEF RANK: #{def_rank} vs {player_pos}"
...
def create_enhanced_bar_chart(games, line, stat_name):
    ...
    fig.add_hline(
        ...
        annotation_font=dict(color="#FFC107", size=13, family='Inter', weight=900)
    )
...
# ========== LAYER 3: PREMIUM PLAYER CARD ==========
    ...
    # Generate game log and calculate stats
            ...
            <div style="display: flex; gap: 1.5rem; align-items: center;">
                <div style="position: relative;">
                    ...
                    <div style="position: absolute; bottom: -8px; right: -8px; width: 40px; height: 40px; background: {team_color};
                                ...
                                border: 2px solid #0A0E1A; font-weight: 900; font-size: 0.9rem;">
                        {player_team}
                    </div>
                </div>
                <div>
    ...
    with col_left:
        ...
        st.markdown(f"""
        <div style="background: #1A1C24; border: 1px solid rgba(255, 193, 7, 0.3); border-radius: 12px; padding: 1.25rem; margin-bottom: 1.5rem;">
            ...
            <div style="display: flex; align-items: baseline; gap: 0.5rem; margin-top: 0.5rem;">
                <span style="color: #FFC107; font-size: 2.5rem; font-weight: 900;">{line}</span>
        ...
        def get_heat_class(rate):
            if rate >= 65: return 'heat-high'
            elif rate >= 50: return 'heat-medium'
            else: return 'heat-low'
        ...
        # Matchup difficulty
        difficulty_class_map = {'easy': 'heat-high', 'medium': 'heat-medium', 'hard': 'heat-low'}
        st.markdown(f"""
        <div class="{difficulty_class_map[difficulty]}" style="border-radius: 12px; padding: 1rem; margin-top: 1.5rem;">
            <div style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; opacity: 0.8;">
                Matchup Difficulty
            </div>
            <div style="font-size: 0.85rem; font-weight: 900; margin-top: 0.5rem;">
                {difficulty_text}
            </div>
        </div>
        """, unsafe_allow_html=True)
