...
VENUE_COORDS = {
    1: ("Oriole Park at Camden Yards", 39.2838, -76.6217),
    2: ("Fenway Park", 42.3467, -71.0972),
    3: ("Guaranteed Rate Field", 41.8300, -87.6339),
    4: ("Great American Ball Park", 39.0979, -84.5082),
    5: ("Progressive Field", 41.4962, -81.6852),
    17: ("Comerica Park", 42.3390, -83.0485),
    19: ("Kauffman Stadium", 39.0516, -94.4803),
    26: ("American Family Field", 43.0280, -87.9712),
    27: ("Target Field", 44.9817, -93.2781),
    3289: ("Yankee Stadium", 40.8296, -73.9262),
    3313: ("Citi Field", 40.7571, -73.8458),
    3312: ("Citizens Bank Park", 39.9056, -75.1665),
    31: ("PNC Park", 40.4469, -80.0057),
    2392: ("Nationals Park", 38.8730, -77.0074),
    4705: ("Truist Park", 33.8908, -84.4678),
    14: ("Wrigley Field", 41.9484, -87.6553),
    32: ("Busch Stadium", 38.6226, -90.1928),
    2602: ("American Family Field", 43.0280, -87.9712),
    2680: ("Chase Field", 33.4455, -112.0667),
    2392: ("Coors Field", 39.7559, -104.9942),
    2602: ("Dodger Stadium", 34.0739, -118.2400),
    2395: ("Oracle Park", 37.7786, -122.3893),
    2406: ("Petco Park", 32.7073, -117.1566),
    680: ("Globe Life Field", 32.7473, -97.0845),
    2394: ("Minute Maid Park", 29.7573, -95.3555),
    2500: ("Angel Stadium", 33.8003, -117.8827),
    2397: ("T-Mobile Park", 47.5914, -122.3325),
    4169: ("loanDepot park", 25.7781, -80.2197),
    2519: ("Tropicana Field", 27.7683, -82.6534),
    1: ("Rogers Centre", 43.6414, -79.3894),
}
