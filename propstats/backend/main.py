...
def fetch_player_game_logs(player_id: str, season: str = "2025-26"):
...
def sync_single_player(player_id: str, secret: str = Query(...)):
    ...
    games_current = fetch_player_game_logs(player_id, "2025-26")
    games_prev = fetch_player_game_logs(player_id, "2024-25")
    
    return {
        "success": games_current > 0 or games_prev > 0,
        "player_id": player_id,
        "games_synced": {
            "2025-26": games_current,
            "2024-25": games_prev
        }
    }
